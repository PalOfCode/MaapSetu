...
function Certificates() {
  ...
  // Optional: set VITE_PUBLIC_WEB_URL in .env for a fixed
  // LAN/production URL. Otherwise use the current React origin.
  ...
  const getVerificationUrl = (
    ...
    return `${PUBLIC_WEB_URL}/verify/${encodeURIComponent(
      certificateId
    )}`;
  };
